...
const SetupConfig = ({
  ...
  useEffect(() => {
    const fetchProviders = async () => {
      try {
        ...
        toast.error(t('setup.loadProvidersFailed'));
      } finally {
        setIsLoading(false);
      }
    };
  ...
  const handleFinish = async () => {
    try {
      ...
      toast.error(t('setup.completeFailed'));
    ...
    <div className="w-[95vw] md:w-[80vw] lg:w-[65vw] mx-auto px-2 sm:px-4 md:px-6 flex flex-col space-y-6">
      ...
      <div className="flex flex-row items-center justify-between pt-2">
        ...
        {setupState === 3 && (
          ...
          >
            <span>
              {isFinishing ? t('setup.finishing') : t('setup.finish')}
            </span>
